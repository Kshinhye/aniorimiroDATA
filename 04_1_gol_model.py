...
# print(gol.info()) # 5 7 10 11 12 15 20
x=gol[['월요일_매출_금액','토요일_매출_금액','일요일_매출_금액','월요일_매출_건수','토요일_매출_건수','일요일_매출_건수']]
y=gol['분기당_매출_금액']
...
#잔차 먼저 얻어줄게요
df_lm=gol.iloc[:,[5,7,10,11,12,15,20]]
...
# ShapiroResult(statistic=0.8704973459243774, pvalue=1.5625879175686035e-41)
...
df2=gol[['주중_매출_금액','시간대_06~11_매출_금액','시간대_11~14_매출_금액','시간대_14~17_매출_금액','남성_매출_금액','연령대_40_매출_금액']]
# print(df2.head(2))
